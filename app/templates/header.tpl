<header class="site-header" role="banner">
  <div class="section-wrapper row">
    ...
    <div class="col-xs-10 col-md-4 site-header-right">
      <h1 class="headline text-right pull-right">
        <a href="#start" class="link" title="{{header.claim}}"><span class="headline-text"><strong class="bold">Christian</strong>Kapke &nbsp;</span><i class="icon-ck-logo"></i></a>
      </h1>
    </div>
  </div>
</header>
